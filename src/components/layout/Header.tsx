...
import { AIAssistantModal } from '../features/AIAssistantModal';
...
export const Header = ({ title, subtitle }: HeaderProps) => {
  ...
  return (
    <>
      ...
      <NewProjectModal isOpen={isProjectOpen} onClose={() => setIsProjectOpen(false)} />
      <NotificationsPanel
        isOpen={isNotifOpen}
