...
import { UserPlus, User, Mail, Lock, ArrowRight, Github } from 'lucide-react';
...
const Signup = () => {
    ...
    const handleSocialSignup = async (provider: any) => {
        try {
            ...
            console.log('Social signup success:', result.user);
            ...
            try {
                await fetch(`${import.meta.env.VITE_API_URL}/api/auth/webhook-trigger`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        name: result.user.displayName,
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_hsl(var(--primary)/0.2),_transparent_70%)] pointer-events-none" />
